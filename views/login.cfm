    ...
    <div class="loginCenter">
        ...
        <div class="rightContent">
            ...
            <div class="iconDiv">
                ...
                <a href="javascript:void(0);" id="googleIcon">
                    <img src="./assets/images/googleicon.JPG" alt="Google Logo" width="45" height="45" class="d-inline-block align-text-top logoImage">
                </a>            
            </div>
